...
#     --payload fileb:///Users/nselvaraj/localstack/lambdas/input.json \
#     --log-type Tail --query 'LogResult' --output text | base64 -d \
#     /Users/nselvaraj/localstack/lambdas/response.json
...
# awslocal lambda update-function-code --function-name my-function --zip-file fileb:///Users/nselvaraj/localstack/lambdas/program.zip

# awslocal logs get-log-events --log-group-name /aws/lambda/test --log-stream-name $(cat /Users/nselvaraj/localstack/lambdas/response.json) --limit 5
